<?php include ROOT.'/views/layouts/header.php' ?>
    ...
    <section class="about-shop  about-shop--catalog">
        <div class="about-shop__wrapper">
            <h4 class="about-shop__title">ПОЛИТИКА КОНФИДЕНЦИАЛЬНОСТИ</h4>
      <p style="padding: 20px;">  

Настоящая Политика конфиденциальности персональных данных (далее – Политика конфиденциальности) действует в отношении всей информации, которую Интернет-магазин «wowsling»,
расположенный на wowsling.ru, может получить о Пользователе во время использования сайта Интернет-магазина.<br>
...
9.3. Все предложения или вопросы по настоящей Политике конфиденциальности следует сообщать в раздел контакты данного сайта.<br>
9.4. Действующая Политика конфиденциальности размещена на странице по адресу wowsling.ru.<br><br>
