...
<?php else: ?>
                ...
                <div class="form-data__block-head">
                	...
                	<h3 class="form-data__content">Мы рады, что вы нашли всё необходимое в магазине Wow Sling!<br> Заполните простую форму заказа и мы свяжемся с вами, чтобы уточнить детали.</h3>
