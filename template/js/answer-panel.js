...
function openPanel(event) {
    ...
    if (!link.classList.contains('answers__content--active')) {  //Проверяем не содержит ли панель класс актив
            // panel.classList.remove('answers__content--active');
            // activeBtn.classList.remove('answers__btn--active');
        ...
        this.classList.remove('answers__btn--active');
        link.classList.remove('answers__content--active');
    }
}


// $(".answers__btn").click(function(event) {
