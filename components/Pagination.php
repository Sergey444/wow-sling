...
class Pagination
{
    ...
    public function get()
    {
        ...
        for ($page = $limits[0]; $page <= $limits[1]; $page++) {
            ...
            if ($page == $this->current_page) {
                $links .= '<li class=" active"><a class="pagination__item " href="#">' . $page . '</a></li>';
            } else {
    ...
    private function generateHtml($page, $text = null)
    {
        ...
        return
                '<li class=""><a class="pagination__item " href="' . $currentURI . $this->index . $page . '">' . $text . '</a></li>';
    }
    ...
    {
        $result = ceil($this->total / $this->limit);
        if ($result > 1) {
            return $result;
        }
